...
const ASSETS = ['./','./index.html','./css/base.css','./css/app.css','./manifest.json',
 ...
 './js/ui/listas.js','./js/ui/modal.js','./js/ui/anual.js','./js/selectors-anual.js','./js/ui/modal-fixo.js','./js/vencimentos.js','./js/cartao.js','./js/parcelas.js','./js/ui/cartao.js','./js/ui/treemap.js'];
