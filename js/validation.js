...
export function validarGasto({ categoria, conta, valorCentavos, data, obs, vencimento, forma, dataCompra, parcela, parcelasTotal, compraId, faturaMes }) {
  ...
  if (/^\d{4}-\d{2}$/.test(faturaMes || '')) dados.faturaMes = faturaMes;
